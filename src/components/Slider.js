  ...
  componentDidMount = () => {
    ...
    firebase
      ...
      .on("value", function(snapshot) {
        ...
        value_slider =
          that.state.update.DIN3.toString() +
          that.state.update.DIN2.toString() +
          that.state.update.DIN1.toString();
        switch (value_slider) {
          case "000":
  ...
  render() {
    ...
    return (
      <div>
        ...
        />
        <br/>
        <h2 className="text-center">Frecuencia: {this.state.value} Hz</h2>
      </div>
    );
  }
}
